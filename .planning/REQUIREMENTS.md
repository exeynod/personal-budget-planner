...
- [ ] **TXN-04**: Под-таб kind (SubTabBar Расходы / Доходы) + чипсы категорий, отфильтрованные по активному kind. Чипса «Все» отсутствует — kindFilter намеренно exclusive (один тип за раз), чипсы кликабельны для category-фильтра.
