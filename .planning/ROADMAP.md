...
Plans:
- [ ] 63-01-PLAN.md — Миграция SubscriptionsViewModel на SubscriptionsV10API (list/patch/post/unpost/delete) + post/unpost мутации + SubscriptionsViewData pure-helpers (create остаётся legacy — V10API без create-эндпоинта)
