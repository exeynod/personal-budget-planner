# Requirements Archive: v0.4 v0.4
...
- [x] **AICAP-01**: `app_user` имеет колонку `spending_cap_cents BIGINT` (scale=100/USD per D-15-02 `ceil(usd*100)`; default = **100 cents = $1/month** per user; alembic 0008 шипнул stub 46500, alembic 0009 [post-v0.4-test-campaign 2026-05-07] выровнял default на 100 после money-scale review) — verified via PATCH cap tests + SELECT default
