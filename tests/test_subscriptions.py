...
# ---------------------------------------------------------------------------
# WRITE path persists day_of_month / account_id (BUG-2, phase 71)
#
# Collapsed (prune): the round-trip below (POST plain → PATCH account+day → GET
# echo) is the canonical write+read assertion; the cross-tenant-404 test guards
# tenant validation on account_id. The former permutations
# (get_v10_fields_round_trip via ORM-set, post_exposes_posted_txn_id — covered
# by the double-post 409 test, create_with_account_and_day, clear_account_id,
# create_missing_account_404, patch_invalid_day_of_month_422) were removed.
# ---------------------------------------------------------------------------
