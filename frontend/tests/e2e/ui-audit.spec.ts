...
test("audit-03: Transactions screen", async ({ page }) => {
  ...
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/03-transactions.png`,
    fullPage: true,
  });
});
...
test("audit-04: Management screen", async ({ page }) => {
  ...
  await page.waitForTimeout(400);
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/04-management.png`,
    fullPage: true,
  });
});
...
test("audit-05: Management subscriptions screen", async ({ page }) => {
  ...
  await page.waitForTimeout(400);
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/05-management-subscriptions.png`,
    fullPage: true,
  });
});
...
test("audit-06: Settings screen", async ({ page }) => {
  ...
  await page.waitForTimeout(400);
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/06-settings.png`,
    fullPage: true,
  });
});
...
test("audit-07: Add transaction bottom sheet", async ({ page }) => {
  ...
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/07-add-transaction.png`,
    fullPage: true,
  });
});
...
test("audit-08: Home empty state", async ({ page }) => {
  ...
  await waitForLoad(page);
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/08-home-empty.png`,
    fullPage: true,
  });
});
...
test("audit-09: Onboarding screen", async ({ page }) => {
  ...
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/09-onboarding.png`,
    fullPage: true,
  });
});
...
test("audit-10: History with category filter", async ({ page }) => {
  ...
  await page.screenshot({
    path: `${SCREENSHOTS_DIR}/10-history-filtered.png`,
    fullPage: true,
  });
});
