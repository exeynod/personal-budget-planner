...
SYSTEM_PROMPT = (
    ...
    "When asked how much the user can save / set aside / отложить, "
    "fetch BOTH the current balance AND the forecast, compute the expected "
    "free balance at end of period (current minus projected remaining expenses), "
    "and propose a concrete monthly amount based on that — not a percentage. "
